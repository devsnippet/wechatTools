...
INSERT INTO `wp_addons` VALUES ('87', 'SmallTools', '小工具', '微信常用的小工具集合,如计算器等', '1', 'null', '陌路生人', '0.1', '1404272965', '1', '1', '1');
...
CREATE TABLE `wp_attribute` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1316 DEFAULT CHARSET=utf8 COMMENT='模型属性表';
...
INSERT INTO `wp_attribute` VALUES ('127', 'is_top', '置顶', 'int(1) NULL', 'bool', '0', '0表示不置顶，否则其它值表示置顶且值是置顶的时间', '1', '0:不置顶\r\n1:置顶', '17', '0', '1', '1402800009', '1394068787', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('844', 'userName', '客服账号', 'varchar(60) NOT NULL ', 'string', '', '', '1', '', '104', '0', '1', '1403959752', '1403947256', '', '3', '', 'regex', '', '0', 'function');
...
INSERT INTO `wp_attribute` VALUES ('1111', 'mTime', '更新时间', 'int(10) NOT NULL', 'datetime', '', '', '0', '', '89', '0', '1', '1406773162', '1406773162', '', '3', '', 'regex', 'time', '3', 'function');
...
INSERT INTO `wp_config` VALUES ('46', 'SYSTEM_UPDATRE_VERSION', '0', '系统升级最新版本号', '4', '', '记录当前系统的版本号，这是与官方比较是否有升级包的唯一标识，不熟悉者只勿改变其数值', '1393764702', '1394337646', '1', '20140822', '0');
...
CREATE TABLE `wp_model` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=152 DEFAULT CHARSET=utf8 COMMENT='文档模型表';
